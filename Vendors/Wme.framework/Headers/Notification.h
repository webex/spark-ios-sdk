...
extern NSString *const MediaEngineDidChangeLocalViewSizeNotification;
extern NSString *const MediaEngineDidChangeRemoteViewSizeNotification;
extern NSString *const MediaEngineDidChangeScreenShareViewSizeNotification;
extern NSString *const MediaEngineDidMuteVideoNotification;
extern NSString *const MediaEngineDidUnMuteVideoNotification;
extern NSString *const MediaEngineDidMuteVideoOutputNotification;
extern NSString *const MediaEngineDidUnMuteVideoOutputNotification;
extern NSString *const MediaEngineDidMuteScreenShareOutputNotification;
extern NSString *const MediaEngineDidUnMuteScreenShareOutputNotification;
extern NSString *const MediaEngineDidMuteAudioNotification;
extern NSString *const MediaEngineDidUnMuteAudioNotification;
extern NSString *const MediaEngineDidMuteAudioOutputNotification;
