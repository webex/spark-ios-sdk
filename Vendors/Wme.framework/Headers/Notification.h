...
extern NSString *const MediaEngineDidChangeLocalScreenShareViewSizeNotification;
...
extern NSString *const MediaEngineDidMuteScreenShareNotification;
extern NSString *const MediaEngineDidUnMuteScreenShareNotification;
