Pod::Spec.new do |s|
  ...
  s.preserve_paths = 'EncryptionKit/SparkSDKEncryptionKit.framework'
  s.xcconfig = { 'FRAMEWORK_SEARCH_PATHS' => '$(PODS_ROOT)/SparkSDK/MediaEngine', 'ENABLE_BITCODE' => 'NO'}
  s.xcconfig = { 'FRAMEWORK_SEARCH_PATHS' => '$(PODS_ROOT)/SparkSDK/EncryptionKit', 'ENABLE_BITCODE' => 'NO'}
  s.vendored_frameworks = "MediaEngine/Wme.framework"
  s.vendored_frameworks = "EncryptionKit/SparkSDKEncryptionKit.framework"
