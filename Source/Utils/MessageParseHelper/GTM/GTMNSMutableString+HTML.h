...
@interface NSMutableString (GTMNSStringHTMLAdditions)

- (void)decodeHTMLEntities;     // calls gtm_stringByUnescapingFromHTML
- (void)encodeHTMLEntitiesWithUnicode:(BOOL)isUnicode;  // calls gtm_stringByEscapingForHTML or gtm_stringByEscapingForAsciiHTML
